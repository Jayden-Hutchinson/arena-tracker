...
export const API_ROUTE = {
    RIOT: {
        ACCOUNT: {
            ...
            BY_PUUID: (puuid) =>
                `${ENDPOINT.RIOT.ACCOUNTS}/by-puuid/${puuid}`
        },
        SUMMONER: {
            BY_PUUID: (puuid) =>
                `${ENDPOINT.RIOT.SUMMONERS}/by-puuid/${puuid}`
        },
        MATCH: {
            BY_PUUID: (puuid) => `${ENDPOINT.RIOT.MATCHES}/by-puuid/${puuid}`,
            BY_ID: (matchId) =>
                `${ENDPOINT.RIOT.MATCHES}/${matchId}`,
        }
    },
